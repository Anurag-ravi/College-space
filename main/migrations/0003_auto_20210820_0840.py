...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='announcement',
            name='remove_after',
            field=models.CharField(choices=[('After 1 week', 'After 1 week'), ('After 1 month', 'After 1 month'), ('After This Semester', 'After This Semester'), ('After 2 week', 'After 2 week'), ('After 3 day', 'After 3 day'), ('After 1 day', 'After 1 day')], max_length=20),
        ),
    ]
